...
public class VerificationCodeServiceConstant {
    ...
    public static final String VERIFICATION_CODE_EXPIRED_BUT_NOT_USED = "Verification Code was expired but not used. Continue.";
    ...
    public static final String STATUS_CODE_OK_VERIFICATION_CODE_VALID = "Verification code valid";
