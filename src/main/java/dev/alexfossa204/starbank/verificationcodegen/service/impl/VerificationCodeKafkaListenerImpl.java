...
import dev.alexfossa204.starbank.verificationcodegen.service.VerificationCodeKafkaListener;
import dev.alexfossa204.starbank.verificationcodegen.service.VerificationCodeService;
import lombok.RequiredArgsConstructor;
import org.springframework.kafka.annotation.KafkaListener;
import org.springframework.stereotype.Component;

import static dev.alexfossa204.starbank.verificationcodegen.config.kafka.KafkaConstant.*;
import static dev.alexfossa204.starbank.verificationcodegen.config.kafka.KafkaVerificationCodeGenerationConsumerConfig.*;
import static dev.alexfossa204.starbank.verificationcodegen.config.kafka.KafkaVerificationCodeSetAsUsedConsumerConfig.*;
